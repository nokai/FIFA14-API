<?php
	...
	class Functionor {
		...
		public function playerImageURI($baseId){
			$pic = "http://cdn.content.easports.com/fifa/fltOnlineAssets/".$this->key."/2014/fut/items/images/players/web/".$baseId.".png";
			return $pic;
		}

		public function clubImageURI($id){
			$pic = "http://cdn.content.easports.com/fifa/fltOnlineAssets/".$this->key."/2014/fut/items/images/clubbadges/web/s".$id.".png";
			return $pic;
		}
		
		public function flagImageURI($id){
			$pic = "http://cdn.content.easports.com/fifa/fltOnlineAssets/".$this->key."/2014/fut/items/images/cardflagsmall/web/".$id.".png";
			return $pic;
		}
	}
